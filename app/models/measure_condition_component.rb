class MeasureConditionComponent < Sequel::Model
  ...
  one_to_one :duty_expression, key: {}, primary_key: {}, eager_loader_key: :duty_expression_id, dataset: -> {
    ...
    DutyExpression.actual
      ...
      if measure_condition_components = id_map[duty_expression.duty_expression_id]
        measure_condition_components.each do |component|
  ...
  one_to_one :measurement_unit, key: {}, primary_key: {}, eager_loader_key: :measurement_unit_code,  dataset: -> {
    ...
    MeasurementUnit.actual
      ...
      if measure_condition_components = id_map[measurement_unit.measurement_unit_code]
        measure_condition_components.each do |component|
  ...
  one_to_one :monetary_unit, key: {}, primary_key: {}, eager_loader_key: :monetary_unit_code, dataset: -> {
    ...
    MonetaryUnit.actual
      ...
      if measure_condition_components = id_map[monetary_unit.monetary_unit_code]
        measure_condition_components.each do |component|
  ...
  one_to_one :measurement_unit_qualifier, key: {}, primary_key: {}, eager_loader_key: :measurement_unit_qualifier_code, dataset: -> {
    ...
    MeasurementUnitQualifier.actual
      ...
      if measure_condition_components = id_map[measurement_unit_qualifier.measurement_unit_qualifier_code]
        measure_condition_components.each do |component|
